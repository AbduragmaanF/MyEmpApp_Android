...
public class AddActivity extends AppCompatActivity {
    ...
    public void AddData(){
        btnAddData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean isInserted = myDb.insertData(editName.getText().toString(),editSurname.getText().toString(),editDepartment.getText().toString(),editEmail.getText().toString());
                if(isInserted == true)
                    Toast.makeText(AddActivity.this,"Data Inserted successfully",Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(AddActivity.this,"Data was not Inserted ",Toast.LENGTH_LONG).show();
            }
        });
    }
    public void viewAll(){
